...
<template>
    <el-scrollbar id="sidebar-wrap" class="scrollbar-wrapper">
        <el-menu background-color="#324057" text-color="#fff" :collapse-transition="false" :default-active="defaultActive"
                 :unique-opened="true" :router="true" mode="vertical" :collapse="isCollapse">
            <!--这一块是点击显示or隐藏侧边栏-->
